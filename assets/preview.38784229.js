var T=Object.defineProperty;var l=(t,a)=>T(t,"name",{value:a,configurable:!0});import{w as E,x as L,d as _,y as h,v as x,b as I}from"./iframe.c58d942a.js";var S="backgrounds",z;function P(t,a){return a||(a=t.slice(0)),Object.freeze(Object.defineProperties(t,{raw:{value:Object.freeze(a)}}))}l(P,"_taggedTemplateLiteral$1");var g=E.document,R=E.window,$=l(function(){var a=R.matchMedia("(prefers-reduced-motion: reduce)");return a.matches},"isReduceMotionEnabled"),H=l(function(a){var e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:[],r=arguments.length>2?arguments[2]:void 0;if(a==="transparent")return"transparent";if(e.find(function(o){return o.value===a}))return a;var n=e.find(function(o){return o.name===r});if(n)return n.value;if(r){var d=e.map(function(o){return o.name}).join(", ");L.warn(_(z||(z=P([`
  ...
  `])))),U=l(function(a,e){var r,n,d,o,u=e.globals,i=e.parameters,s=i[S].grid,p=((r=u[S])===null||r===void 0?void 0:r.grid)===!0&&s.disable!==!0,v=s.cellAmount,f=s.cellSize,m=s.opacity,w=e.viewMode==="docs",c;(n=i.grid)!==null&&n!==void 0&&n.cellSize?(c=i.grid.cellSize,Y()):c=f;var j=i.layout===void 0||i.layout==="padded",B=j?16:0,b=(d=s.offsetX)!==null&&d!==void 0?d:w?20:B,k=(o=s.offsetY)!==null&&o!==void 0?o:w?20:B,M=h(function(){var y=e.viewMode==="docs"?"#anchor--".concat(e.id," .docs-story"):".sb-show-main",C=["".concat(c*v,"px ").concat(c*v,"px"),"".concat(c*v,"px ").concat(c*v,"px"),"".concat(c,"px ").concat(c,"px"),"".concat(c,"px ").concat(c,"px")].join(", ");return`
    ...
    `)},[c]);return x(function(){var y=e.viewMode==="docs"?"addon-backgrounds-grid-docs-".concat(e.id):"addon-backgrounds-grid";if(!p){O(y);return}G(y,M)},[p,M,e]),a()},"withGrid"),q=[U,F],J={backgrounds:{grid:{cellSize:20,opacity:.5,cellAmount:5},values:[{name:"light",value:"#F8F8F8"},{name:"dark",value:"#333333"}]}};export{q as decorators,J as parameters};
//# sourceMappingURL=preview.38784229.js.map
